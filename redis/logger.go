...
func (lg *logger) Debug(msg ...interface{}) {
	msg = append([]interface{}{"[Debug][kelp.redis]"}, msg...)
	syslog.Println(msg...)
}

func (lg *logger) Info(msg ...interface{}) {
	msg = append([]interface{}{"[Info][kelp.redis]"}, msg...)
	syslog.Println(msg...)
}

func (lg *logger) Warn(msg ...interface{}) {
	msg = append([]interface{}{"[Warn][kelp.redis]"}, msg...)
	syslog.Println(msg...)
}

func (lg *logger) Error(msg ...interface{}) {
	msg = append([]interface{}{"[Error][kelp.redis]"}, msg...)
	syslog.Println(msg...)
}
